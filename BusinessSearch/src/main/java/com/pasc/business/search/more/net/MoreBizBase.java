...
import com.pasc.business.search.home.net.HomeApiBase;
 ...
 * @modify
 **/
public class MoreBizBase {

  /****行政区划列表--办事指南***/
  public static Single<List<AreaBean>> getAreaList() {
    return ApiGenerator.createApi(MoreApiBase.class).getAreaList(VoidObject.getInstance())
  ...
  public static Single<List<DeptBean>> getDeptByArea(DeptParam param) {
    return ApiGenerator.createApi(MoreApiBase.class).getDeptByArea(param)
        .subscribeOn(Schedulers.io())
  ...
  public static Single<List<DeptBean>> getStreetByArea(StreetParam param) {
    return ApiGenerator.createApi(MoreApiBase.class).getStreetByArea(param)
        .subscribeOn(Schedulers.io())
        .compose(RespV2Transformer.<List<DeptBean>>newInstance())
        .observeOn(AndroidSchedulers.mainThread());
  }
  ...
  public static Single<UnitSearchBean> policyUnitSearch() {
    return ApiGenerator.createApi(MoreApiBase.class).unitSearch()
        .subscribeOn(Schedulers.io())
  ...
  public static Single<TotalCountResponse> searchByCondition(final SearchParam searchParam) {
    ...
    //        } else {
    single = ApiGenerator.createApi(HomeApiBase.class)
        .appNetworkSearch(searchParam);
    //        }
    return single
        .subscribeOn(Schedulers.io())
